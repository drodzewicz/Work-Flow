            ...
            <nav aria-label="pagination" className={`pagination ${className}`}>
                {current !== 1 ? (
                    <>
                        ...
                        <div className={`pagination__elipsis ${current - 1 === 1 ? "hide" : ""}`}>
                            ...
                        </div>
                        <button
                ...
                <button
                    ...
                    className="pagination__item pagination__current-page"
                >
                    {current}
                </button>
                {current !== total ? (
                    <>
                        ...
                        <div
                            className={`pagination__elipsis ${current + 1 === total ? "hide" : ""}`}
                        >
                            ...
                        </div>
                        <button
